...
export default function PhoneFrontScreen({
  ...
  return (
    <div
      className={`absolute top-1/2 flex h-1/2 w-full origin-bottom flex-col rounded-md border-2 border-black bg-slate-100 transition-transform duration-1000 ${
        open ? "[transform:rotateX(0deg)]" : "[transform:rotateX(180deg)]"
      } transform-style-preserve-3d backface-hidden flex flex-col items-center p-2`}
      onClick={switchOpen}
    >
