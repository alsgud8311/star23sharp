export default function PhoneFront({
  ...
  return (
    <div
      className={`-bottom-1/2 h-1/2 w-full rounded-md border-2 bg-white [backface-visibility:hidden] ${open ? "[perspective(800px)] [transform-style: preserve-3d] [transform:rotateX(180deg)]" : "[transform:rotateX(0deg)]"} absolute z-10 flex origin-top flex-col border-black transition-transform duration-1000`}
      onClick={switchOpen}
    >
